...
public class Box2DFragment extends AndroidFragmentApplication implements InputProcessor {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        m_viewRooter = inflater.inflate(com.dayudesgin.goldcoin.R.layout.lf_layout_giftparticle, null);
    ...
    public void buildGDX() {
        ...
        mContainer = (InterceptableViewGroup) m_viewRooter.findViewById(com.dayudesgin.goldcoin.R.id.container);
